...
class StrBinaryTree {
private:
   // TreeNode is a private structure for StrBinaryTree nodes.
   struct TreeNode {
...
// Implementation file for the StrBinaryTree class
#include <iostream>
...
void StrBinaryTree::insertNode(string val) {
   TreeNode *newNode;      // Pointer to a new node.

   // Create a new node and store string value in it.
...
bool StrBinaryTree::searchNode(string val) {
...
void StrBinaryTree::remove(string val) {
   deleteNode(val, root);
}
